...
summary: "Understand the adversaries Cypherlots are designed to resist."
date: 2025-01-22
...
Cypherlots assume a world where metadata surveillance is the default. Implementers must understand who we defend against and where the limits lie.
...
Continue with the [Cypherlot Core Protocol](/specs/rfc-0001-core) for normative requirements.
